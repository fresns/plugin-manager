...
class PluginTest extends TestCase
{
    ...
    public function test_it_gets_kebabcase_module_name()
    {
        $this->assertEquals('pluginone', $this->plugin->getKebabName());
    }
    ...
    public function test_it_checks_plugin_activated_status()
    {
    ...
    public function test_it_fires_events_when_plugin_is_activated()
    {
        $this->expectsEvents([
            'plugins.activating',
            'plugins.activated',
